  ...
  describe 'methods' do
    ...
    describe '#food_trucks_that_sell' do
      ...
      it 'returns an Array of FoodTrucks' do
        expect(@event.food_trucks_that_sell('Peach Pie (Slice)').all? { |food_truck|
                 food_truck.class == FoodTruck
               }).to eq(true)
      end
    ...
    describe 'sorted_item_list' do
      ...
      it 'returns expected array of names' do
    ...
    describe 'total_inventory' do
      ...
      it 'returns a sub-hash whos keys are quantity and food_trucks' do
        expect(@event.total_inventory.values.all? { |sub_hash|
                 sub_hash.keys == [:quantity, :food_trucks]
               }).to eq(true)
      end
      ...
      it 'returns a sub-hash whos food_truck values are Arrays of FoodTrucks' do
        expect(@event.total_inventory.values.all? { |sub_hash|
                 sub_hash[:food_trucks].all? { |food_truck|
                   food_truck.class == FoodTruck
                 }
               }).to eq(true)
      end
