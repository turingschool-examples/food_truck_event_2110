...
RSpec.describe Event do
  ...
  it "can filter trucks by what they sell" do
    @event.add_food_truck(@food_truck1)
    @event.add_food_truck(@food_truck2)
    @event.add_food_truck(@food_truck3)
  ...
  it "can filter trucks by item 4" do
    @event.add_food_truck(@food_truck1)
    @event.add_food_truck(@food_truck2)
    @event.add_food_truck(@food_truck3)
  ...
  it "can show potential revenue for truck 1" do
    @event.add_food_truck(@food_truck1)
    @event.add_food_truck(@food_truck2)
    @event.add_food_truck(@food_truck3)
  ...
  it "can show potential revenue for truck 2" do
    @event.add_food_truck(@food_truck1)
    @event.add_food_truck(@food_truck2)
    @event.add_food_truck(@food_truck3)
  ...
  describe 'iteration 4' do
    ...
    it 'can not sell more that inventory' do
